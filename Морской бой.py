...
class Field(object):
    ...
    def get_max_weight_cells(self):
        ...
        # заодно запоминаем максимальное значение. далее берём из словаря список координат с этим
        ...
        for ship_size in Game.ships_rules:
            ...
            while True:
                ...
                if player.auto_ship_setup is not True:
                    ...
                    player.message.append('Куда поставить {} корабль в формате x+y+(H или V): '.format(ship_size))
